...
<!-- Hero Section -->
    <section class="max-w-7xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center gap-12">
        ...
        <div class="flex-1 relative">
            ...
            <img src="{{ $events->first()?-> poster_path ? asset('storage/'.$events->first()->poster_path) : 'https://placehold.co/600x800' }}"
    alt="{{ $events->first()?->title ?? 'AmikomEventHub'}}"
...
<section id="partners" class="max-w-7xl mx-auto px-6 py-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <h2>Partner Kami ({{ $partners->count() }})</h2>
