...
<body class="bg-slate-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-xl shadow-lg border border-slate-200 max-w-md w-full">
        ...
        <div class="flex flex-wrap justify-center gap-3">
            ...
            <a href="/profil" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">Profil</a>
            <a href="/katalog" class="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700">Katalog</a>
            <a href="/kontak" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700">Kontak</a>
        </div>
    </div>
</body>
</html>