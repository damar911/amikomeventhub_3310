                ...
                <tbody class="divide-y border-t">
                    @forelse($events as $index => $event)
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-8 py-6">
                                <img src="{{ $event->poster_path ? asset('storage/'.$event->poster_path) : 'https://placehold.co/16x20' }}"
...
text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition">
    ...
    15H9v-2.828l8.586-8.586z"></path>
                                    ...
                                    <form action="{{ route('admin.events.destroy', $event->id) }}" method="POST"
                                        ...
                                        <button type="submit"
                                            class="p-2.5
bg-rose-50 text-rose-600 rounded-xl hover:bg-rose-600 hover:text-white
transition">
            ...
            7h16"></path>
                    ...
                    @empty
                        <tr>
                            ...
                            <td colspan="5" class="px-8 py-10 text-center text-slate-500">Belum ada acara yang
                                ditambahkan.</td>
